<?php
abstract class DB_Connection{       // abstract so that objects should not be instantiated even by mistake
    protected function obj_db(){    // protected is for the sake of inheritance
